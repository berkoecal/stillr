...
function Navbar() {
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: "2px", fontSize: "1.5rem", fontWeight: 900, letterSpacing: "0.04em" }}>
  ...
  return (
    <section className="hero-section" style={{
      ...
      <div style={{
        ...
        background: "rgba(0,207,255,0.13)", filter: "blur(110px)",
        zIndex: 0, animation: "orb-drift-1 14s ease-in-out infinite",
      }} />
      <div style={{
        position: "absolute", top: "-15%", right: "-8%",
        width: "750px", height: "750px", borderRadius: "50%",
        background: "rgba(168,85,247,0.11)", filter: "blur(130px)",
        zIndex: 0, animation: "orb-drift-2 18s ease-in-out infinite",
      }} />
      <div style={{
        position: "absolute", top: "35%", left: "38%",
        width: "400px", height: "400px", borderRadius: "50%",
        background: "rgba(0,207,255,0.055)", filter: "blur(90px)",
        zIndex: 0, animation: "orb-drift-3 11s ease-in-out infinite",
      }} />
...
{/* ── Flasche — absolut positioniert ── */}
      <div className="hero-bottle-wrap">
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse, rgba(0,207,255,0.18) 0%, rgba(168,85,247,0.10) 45%, transparent 70%)",
          filter: "blur(40px)",
        ...
        ] as { label: string; side: "left" | "right"; top: string; leftOverride?: string; rightOverride?: string }[]).map((usp, i) => (
          <div
            key={usp.label}
      ...
      <div className="hero-content-grid">
        {/* Left: editorial text */}
        <div>
          <p className="hero-overline" style={{
          ...
          <div style={{
            ...
            <div style={{ width: "48px", height: "2px", background: "#00CFFF", borderRadius: "2px", flexShrink: 0 }} />
            <p style={{
              fontSize: "clamp(0.95rem, 1.8vw, 1.15rem)", fontWeight: 400,
              color: "rgba(255,255,255,0.75)", margin: 0, lineHeight: 1.5,
            }}>
              Erstklassiges funktionales Wasser,<br />entwickelt für die Tanzfläche.
            </p>
          </div>
          ...
          <div style={{
            ...
            <a href="#notify" style={{
              ...
              padding: "14px 36px", fontSize: "0.9rem", fontWeight: 800,
              letterSpacing: "0.05em", textTransform: "uppercase",
              boxShadow: "0 0 40px rgba(0,207,255,0.45)",
              transition: "transform 0.2s, box-shadow 0.2s",
            }}
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 0 60px rgba(0,207,255,0.7)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 0 40px rgba(0,207,255,0.45)"; }}
            >
              Früher Zugang
            </a>
            <a href="#story" style={{
      ...
      <div className="hero-scroll-indicator">
        <span style={{ fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.35)", writingMode: "vertical-rl" }}>Scroll</span>
  ...
  return (
    <section id="story" ref={ref} style={{
      ...
      <div style={{
        ...
        background: "rgba(168,85,247,0.07)", filter: "blur(100px)", zIndex: 0,
      }} />
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          letterSpacing: "0.22em", textTransform: "uppercase",
          color: "#00CFFF", marginBottom: "2.5rem",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "start" }}>
          ...
          <div>
            <h2 style={{
              ...
              Stay Sharp.<br />
              <span style={{ color: "#00CFFF" }}>Stay Out</span><br />
              Longer.
            </h2>
            <p style={{
              marginTop: "2rem",
              ...
              Wir haben STILLR für alle kreiert, die die Nacht voll auskosten — ohne Zucker-Crash, ohne Kater, ohne Kompromisse.
            </p>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={label} style={{
                  ...
                  <span style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.45)", letterSpacing: "0.05em" }}>{label}</span>
                  <span style={{ fontSize: "1.8rem", fontWeight: 900, color: "#fff", letterSpacing: "-0.02em" }}>{val}</span>
                </div>
              ))}
            </div>
          </div>
...
/* ────────────────────────────────────────────────────────
   ...
   ──────────────────────────────────────────────────────── */
const FEATURES = [
  { num: "01", title: "Elektrolyt-Komplex", desc: "Magnesium, Kalium & Natrium — optimale Hydrierung die ganze Nacht." },
  { num: "02", title: "Clean Label", desc: "Kein Zucker. Keine künstlichen Süßstoffe. Kein Bullshit." },
  { num: "03", title: "Pure Taste", desc: "Natürliche Fruchtaromen. Echter Geschmack, null Kompromisse." },
...
function FeaturesSection() {
  ...
  return (
    <section ref={ref} id="features" className="features-section" style={{
      background: "#060810",
      ...
      <div style={{
        ...
        width: "500px", height: "500px", borderRadius: "50%",
        background: "rgba(0,207,255,0.05)", filter: "blur(100px)", zIndex: 0,
      }} />
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{
          fontSize: "0.72rem", fontWeight: 700,
          letterSpacing: "0.22em", textTransform: "uppercase",
          color: "rgba(255,255,255,0.35)", marginBottom: "4rem",
        ...
        <div className="features-grid">
          {FEATURES.map((f, i) => (
            <div key={f.num} className="features-item"
              style={{
                opacity: inView ? 1 : 0,
            ...
            >
              <div style={{ fontSize: "0.7rem", color: "#00CFFF", fontWeight: 700, letterSpacing: "0.1em", marginBottom: "1.5rem" }}>{f.num}</div>
              <h3 style={{ fontSize: "1.1rem", fontWeight: 800, marginBottom: "0.75rem", lineHeight: 1.2 }}>{f.title}</h3>
              <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.7 }}>{f.desc}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        {["Club Ready", "Bar Approved", "Kein Kater", "Volle Energie", "Party-Proof", "Alkoholfrei"].map(tag => (
          <span key={tag} style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <blockquote style={{
          ...
          letterSpacing: "-0.03em", margin: "0 auto",
          maxWidth: "900px",
          opacity: inView ? 1 : 0, transform: inView ? "none" : "translateY(30px)",
          transition: "all 0.7s ease 0.2s",
        }}>
          &ldquo;Hydrate without<br />
  ...
  return (
    <section id="notify" ref={ref} style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 50% 80%, rgba(0,207,255,0.08) 0%, transparent 60%)",
        zIndex: 0,
      }} />
      ...
      <div style={{
        ...
        <p style={{
          ...
          textTransform: "uppercase", color: "#00CFFF",
          marginBottom: "1.5rem",
          opacity: inView ? 1 : 0, transition: "all 0.7s ease",
        }}>✦ Coming Soon ✦</p>
        ...
        {state.succeeded ? (
          <div style={{
            ...
            borderRadius: "20px", padding: "1.5rem 2.5rem",
